...
import { distanceZ } from "./globalFunctions";

export function Projectile(shooter, model, trail, speed, range, dmg, owner) {
    this.typeNum = 0;
    this.model = model;
    this.model1 = trail;
    this.speed = speed;
...
export function Bulet(shooter, trail, range, dmg, owner) {
    this.typeNum = 0;
    this.model = trail;
    this.range = range;
    this.dmg = dmg;
...
export function Barr(shooter, barr, bar2) {
    this.typeNum = 1;
    this.owner = shooter;
    this.model = barr;
    this.model1 = bar2;
...
export function Explosion(size, model, sphere) {
    this.typeNum = 2;
    this.model = model;
    this.size = size;
    if (!sphere)

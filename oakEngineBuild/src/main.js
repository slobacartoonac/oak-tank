...
OAK.Camera=require("./camera.js").Camera;
OAK.Lights=require("./lights.js").Lights;
OAK.Mesh=require("./mesh.js").Mesh;
OAK.Rendable=require("./rendable.js").Rendable;
OAK.ARendable=require("./rendable.js").ARendable;
OAK.Shader=require("./shader.js").Shader;
OAK.Loader=require("./loader.js").Loader;
...
OAK.Engine.prototype.initShaders=function() {
        ...
        this.shaderProgram=new OAK.Shader(gl,vertexShader,fragmentShader,
        ...
        lightd=vecmath.vNormalise(lightd);
...
OAK.Engine.prototype.initShadersPackage=function(shaderPackage) {
        ...
        shaderPackage.program=new OAK.Shader(gl,this.vertexShader(shaderPackage.vertex),this.fragmentShader(shaderPackage.fragment),

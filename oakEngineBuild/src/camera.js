...
{
    var f =  vecmath.vNormalise(vecmath.minus3(this.target,this.position));
    var u=vecmath.vNormalise(this.up);
    var s = vecmath.vNormalise(vecmath.v3CrossProduct(f , u));
    u = vecmath.v3CrossProduct(s , f);
    ...
    this.mat[6] =-f.y;
    this.mat[10] =-f.z;
    this.mat[12] =-vecmath.vDotProduct(s, this.position);
    this.mat[13] =-vecmath.vDotProduct(u, this.position);
    this.mat[14] = vecmath.vDotProduct(f, this.position);

    var lpos={x:this.light.x+this.target.x,y:this.light.y+this.target.y,z:this.light.z+this.target.z}
    f =  vecmath.vNormalise(vecmath.minus3(this.target,lpos));
    u=vecmath.vNormalise({x:0,y:1,z:0});
    s = vecmath.vNormalise(vecmath.v3CrossProduct(f , u));
    u = vecmath.v3CrossProduct(s , f);
    ...
    this.light_mat[12] =-vecmath.vDotProduct(s, lpos);
    this.light_mat[13] =-vecmath.vDotProduct(u, lpos);
    this.light_mat[14] = vecmath.vDotProduct(f, lpos);
